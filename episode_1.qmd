...
In a terminal window navigate to your `RNA-seq`{style="color:black"} directory. Ensure you have a sub-directory that contains your raw sequence files (called `Raw`{style="color:black"}), and separate sub-directory in which to store quality control outputs (name this `QC`{style="color:black"}).
...
```bash
cat */summary.txt > ~/obss_2025/rnaseq/QC/fastqc_summaries.txt
```
